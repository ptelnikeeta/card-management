<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="card-create-submit">
            @csrf
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="wp_number" name="wp_number" value="{{old('wp_number')}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="contacts">Contacts</label>
                        <input type="text" class="form-control" id="contacts" name="contacts" data-role="tagsinput" value="{{old('contacts')}}">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="photo" name="photo" style="display: none">{{old('photo')}}</textarea>
                        <div class="row mb-3">
                            <div class="col-12">
